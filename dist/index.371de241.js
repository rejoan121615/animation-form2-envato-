...
registerBtn.addEventListener("click", () => {
  ...
  _gsap.gsap.timeline().to("#sign__in", {
    opacity: 0,
    zIndex: 0,
    duration: 0.35
  }).to("#sign__in", {
...
logIn.addEventListener("click", () => {
  // form animation
  _gsap.gsap.timeline().to("#sign__up", {
    opacity: 0,
    zIndex: 0,
    duration: 0.5
  }).to("#sign__up", {
...
},{"../scss/style.scss":"188h8","gsap":"1iecp"}],"188h8":[function() {},{}],"1iecp":[function(require,module,exports) {
var define;
...
},{}]},["5Jifb","1oPsV"], "1oPsV", "parcelRequire1eea")
